...
const ContactSection = () => {
    ...
    const InfoBlock = ({ Icon, title, value, detail, isCopyable, copyKey }) => (
    ...
    return (
        <div className="w-full max-w-6xl mx-auto p-4 sm:p-8 z-10 flex flex-col justify-center min-h-screen">
