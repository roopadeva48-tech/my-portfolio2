...
import { X } from 'lucide-react'; // Needed for the Close Button icon (X)
...
// =========================================================================
// 2. HELPER COMPONENTS (Background, Certifications, Chatbot UI)
// =========================================================================
...
                ></div>
            ))}
            {/* Simple CSS-based lines (visualizing connections) */}
...
            </div>
            ...
            {/* 2. CERTIFICATIONS SECTION (SCROLL BLOCK) */}
            <CertificationsSection />

            {/* 3. FULL-WIDTH CHATBOT (SCROLL BLOCK) */}
            <FullWidthChatbot 
                messages={messages}
