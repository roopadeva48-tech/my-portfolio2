...
// --- Social Icons (MODIFIED: Increased size to w-8 h-8 and set default color) ---
const LinkedInIcon = () => (
...
// --- Animated Tech Stack Component (Inherited Changes) ---
        ...
        <div className="relative overflow-hidden min-h-[80px]" ref={animationContainerRef}>
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start opacity-0 pointer-events-none w-full" ref={staticLayoutRef}>
                {techIconsData.map((tech, index) => {
                    ...
                    return (
                        <div key={`static-${tech.name}`} className="tech-icon-initial-layout w-8 h-8 flex items-center justify-center"> 
                            <IconComponent />
                        </div>
                    );
                })}
                        ...
                        >
                            <div 
                                ...
                                style={{
                                    ...
                                    color: tech.hoverColor // Now uses the designated tech color
                                }}
                                // Hover effect: change to white on hover, revert on mouse leave
...
// --- Home Section (MODIFIED: Updated Social Links and Styles) ---
        ...
        <div className="w-full h-full flex flex-col md:flex-row items-center justify-center p-6 md:p-12 gap-10">
            ...
            <div className="w-full md:w-1/2 space-y-6 animate-fade-in-up text-center md:text-left z-10">
                ...
                <div className="flex gap-6 pt-4 justify-center md:justify-start">
                    {/* LinkedIn Link (Uses neon-blue color for vibrancy) */}
                    <a 
                        href={LINKEDIN_URL} // ADDED URL
                        target="_blank"
                        rel="noopener noreferrer"
                        // MODIFIED: Use a vibrant neon-blue color by default for "colourful" look
                        className="text-neon-blue hover:text-white transition-colors hover:scale-110 transform duration-200"
                    >
                        <span className="sr-only">LinkedIn</span>
                        <LinkedInIcon /> {/* Now larger: w-8 h-8 */}
                    </a>

                    {/* GitHub Link (Uses neon-pink color for vibrancy) */}
                    <a 
                        href={GITHUB_URL} // ADDED URL
                        target="_blank"
                        rel="noopener noreferrer"
                        // MODIFIED: Use a vibrant neon-pink color by default for "colourful" look
                        className="text-neon-pink hover:text-white transition-colors hover:scale-110 transform duration-200"
                    >
                        <span className="sr-only">GitHub</span>
                        <GithubIcon /> {/* Now larger: w-8 h-8 */}
                    </a>
                </div>
            </div>
