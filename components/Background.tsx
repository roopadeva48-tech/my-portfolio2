...
const Background: React.FC = () => {
  ...
  // The animation duration is now controlled by the 'animate-star-drift' class in tailwind.config.js
  ...
  return (
    <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden bg-black">
      ...
      {/* The animate-star-drift speed is configured in tailwind.config.js for a slow loop (e.g., 90 seconds) */}
